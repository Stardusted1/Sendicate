...
const userTypeMisc = document.getElementsByName("userType")[0].value;

function historyChosen(data) {
    data.className += " current-button";
    if (userTypeMisc === "PROVIDER")
...
function selectAnother(id) {
    ...
    switch (id) {
        case "0": //Humidity history
            HistoryLabel.innerText = "Humidity history";
        ...
        case "1": //Temperature history
            HistoryLabel.innerText = "Temperature history";
        ...
        case "2"://Luminosity history
            HistoryLabel.innerText = "Luminosity history";
        ...
        case "3"://Acceleration history
            HistoryLabel.innerText = "Acceleration history";
...
function selectAnotherOld(id) {
    var HumidityChart = document.getElementById("HumidityChartOld");
    var TemperatureChart = document.getElementById("TemperatureChartOld");
    var LuminosityChart = document.getElementById("LuminosityChartOld");
    var AccelerationChart = document.getElementById("AccelerationChartOld");
    var HistoryLabel = document.getElementById("HistoryLabelOld");
    switch (id) {
        case "0": //Humidity history
            HistoryLabel.innerText = "Humidity history";
            HumidityChart.className = HumidityChart.className.split(" ")[0];
